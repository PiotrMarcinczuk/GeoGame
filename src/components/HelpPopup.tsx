...
export default function HelpPopup({ setHelpPopupIsVisible }: HelpPopupProps) {
  return (
    <>
      ...
      <section className="max-w-[1466px] max-h-[996px] 2xl:max-h-[912px] h-full flex flex-col overflow-y-auto xl:overflow-y-hidden xl:flex-row fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-50 w-full mx-2 p-4 md:p-10 text-black text-xl bg-white rounded-sm">
          ...
          <div className="flex flex-col justify-between h-full mt-6 lg:mt-0 xl:mt-12 lg:ml-12 xl:ml-0">
            <div className="lg:w-9/10 xl:w-auto">
              ...
              <ul className="list-disc">
                <li>
                  After guessing it, the country stays the same it changes every
                  day.
                </li>
                <li>
                  Largest city, Export, GDP per capita, and Urban population are
                  from 2024, Afforestation and Natural Resources are from 2021.
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="flex flex-col mt-12 xl:mt-0 xl:ml-36 2xl:ml-52 mr-16">
          <div className="flex flex-col mb-2">
            <p className="text-2xl font-semibold">Largest city</p>
            <p className="text-xl mt-1">
              The population of the largest city in the country, expressed as a
              percentage of the total urban population.
            </p>
            <p className="mt-1">
              <span className="font-semibold">Example:</span> If the largest
              city has 2 million people and total urban population is 10 million
              → value = 20%.
            </p>
          </div>
          <div className="flex flex-col my-3">
          ...
          <div className="flex flex-col my-3">
            ...
            <p className="mt-1">
              <span className="font-semibold">Example:</span> GDP = $1 trillion,
              population = 50 million → GDP per capita = $20,000.
            </p>
          </div>
          <div className="flex flex-col my-3">
        ...
        <button
          ...
          className="absolute top-4 md:top-10 right-4 md:right-10 hover:cursor-pointer p-3 -m-3 rounded-sm hover:bg-[#ECECEC] tranisition-all duration-300 ease-out"
        >
